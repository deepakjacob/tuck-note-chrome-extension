# Tuck Note Chrome Extension

A lightweight notes app that can be either built as a **Chrome extension** or a a standard **web app** with React, TypeScript and Webpack **at the same time**.

### Setup options

You can change the options used in the `setupProject` function in  [src/index.tsx](https://github.com/deepakjacob/tuck-note-chrome-extension/blob/main/src/index.tsx) to specify your React root component, and where the React root component will be rendered.
...
`extension manifest` - [extension-manifest.json](https://github.com/deepakjacob/tuck-note-chrome-extension/blob/main/public/extension-manifest.json)

`web app manifest` - [web-app-manifest.json](https://github.com/deepakjacob/tuck-note-chrome-extension/blob/main/public/web-app-manifest.json)
